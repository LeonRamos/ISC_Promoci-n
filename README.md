...
[![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?logo=javascript&logoColor=000000)](https://developer.mozilla.org/es/docs/Web/JavaScript) 
...
[![Java](https://img.shields.io/badge/Java-007396?logo=java&logoColor=ffffff)](https://www.oracle.com/java/) 
[![C](https://img.shields.io/badge/C-555555?logo=c&logoColor=ffffff)](https://en.cppreference.com/w/c) 
[![C++](https://img.shields.io/badge/C%2B%2B-00599C?logo=c%2B%2B&logoColor=ffffff)](https://isocpp.org/) 
[![C#](https://img.shields.io/badge/C%23-239120?logo=c%23&logoColor=ffffff)](https://docs.microsoft.com/dotnet/csharp/) 
...
[![Angular](https://img.shields.io/badge/Angular-DD0031?logo=angular&logoColor=ffffff)](https://angular.io/) 
[![Next.js](https://img.shields.io/badge/Next.js-000000?logo=next.js&logoColor=ffffff)](https://nextjs.org/) 
[![Bootstrap](https://img.shields.io/badge/Bootstrap-7952B3?logo=bootstrap&logoColor=ffffff)](https://getbootstrap.com/) 
[![Tailwind CSS](https://img.shields.io/badge/Tailwind_CSS-38B2AC?logo=tailwindcss&logoColor=ffffff)](https://tailwindcss.com/) 
[![Sass](https://img.shields.io/badge/Sass-C69?logo=sass&logoColor=ffffff)](https://sass-lang.com/)
...
[![Django](https://img.shields.io/badge/Django-092E20?logo=django&logoColor=ffffff)](https://www.djangoproject.com/) 
[![Flask](https://img.shields.io/badge/Flask-000000?logo=flask&logoColor=ffffff)](https://flask.palletsprojects.com/) 
[![Spring Boot](https://img.shields.io/badge/Spring_Boot-6DB33F?logo=spring&logoColor=ffffff)](https://spring.io/projects/spring-boot) 
[![.NET](https://img.shields.io/badge/.NET-512BD4?logo=.net&logoColor=ffffff)](https://dotnet.microsoft.com/)

## Bases de datos
[![MySQL](https://img.shields.io/badge/MySQL-4479A1?logo=mysql&logoColor=ffffff)](https://www.mysql.com/) 
[![PostgreSQL](https://img.shields.io/badge/PostgreSQL-336791?logo=postgresql&logoColor=ffffff)](https://www.postgresql.org/) 
[![MongoDB](https://img.shields.io/badge/MongoDB-47A248?logo=mongodb&logoColor=ffffff)](https://www.mongodb.com/) 
[![SQLite](https://img.shields.io/badge/SQLite-003B57?logo=sqlite&logoColor=ffffff)](https://www.sqlite.org/) 
[![Redis](https://img.shields.io/badge/Redis-D92B2B?logo=redis&logoColor=ffffff)](https://redis.io/)
...
[![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-2088FF?logo=githubactions&logoColor=ffffff)](https://github.com/features/actions) 
[![Jenkins](https://img.shields.io/badge/Jenkins-D24939?logo=jenkins&logoColor=ffffff)](https://www.jenkins.io/) 
[![Terraform](https://img.shields.io/badge/Terraform-7B42BC?logo=terraform&logoColor=ffffff)](https://www.terraform.io/) 
[![Ansible](https://img.shields.io/badge/Ansible-EE0000?logo=ansible&logoColor=ffffff)](https://www.ansible.com/)

## Cloud / Infraestructura
[![AWS](https://img.shields.io/badge/AWS-232F3E?logo=amazonaws&logoColor=FF9900)](https://aws.amazon.com/) 
[![Azure](https://img.shields.io/badge/Microsoft_Azure-0089D6?logo=microsoftazure&logoColor=ffffff)](https://azure.microsoft.com/) 
[![GCP](https://img.shields.io/badge/Google_Cloud-4285F4?logo=googlecloud&logoColor=ffffff)](https://cloud.google.com/)

## Contenedores / Orquestación
[![Docker Compose](https://img.shields.io/badge/Docker%20Compose-2496ED?logo=docker&logoColor=ffffff)](https://docs.docker.com/compose/) 
[![Helm](https://img.shields.io/badge/Helm-0F172A?logo=helm&logoColor=ffffff)](https://helm.sh/)

## Testing / Calidad
[![Jest](https://img.shields.io/badge/Jest-C21325?logo=jest&logoColor=ffffff)](https://jestjs.io/) 
[![Mocha](https://img.shields.io/badge/Mocha-8D6748?logo=mocha&logoColor=ffffff)](https://mochajs.org/) 
[![PyTest](https://img.shields.io/badge/PyTest-244C79?logo=pytest&logoColor=ffffff)](https://docs.pytest.org/) 
[![JUnit](https://img.shields.io/badge/JUnit-25A162?logo=junit5&logoColor=ffffff)](https://junit.org/)
...
[![Kafka](https://img.shields.io/badge/Kafka-231F20?logo=apachekafka&logoColor=ffffff)](https://kafka.apache.org/)

## Servidores / Reverse Proxy
[![Nginx](https://img.shields.io/badge/Nginx-009639?logo=nginx&logoColor=ffffff)](https://www.nginx.com/) 
[![Apache](https://img.shields.io/badge/Apache-CA1F2A?logo=apache&logoColor=ffffff)](https://httpd.apache.org/)

## Redes / Protocolos / APIs
[![REST](https://img.shields.io/badge/REST-API-00ADEF)](https://restfulapi.net/) 
[![GraphQL](https://img.shields.io/badge/GraphQL-E10098?logo=graphql&logoColor=ffffff)](https://graphql.org/) 
[![WebSocket](https://img.shields.io/badge/WebSocket-000000?logo=websocket&logoColor=ffffff)](https://developer.mozilla.org/docs/Web/API/WebSockets_API)

## Seguridad
[![OpenSSL](https://img.shields.io/badge/OpenSSL-000000?logo=openssl&logoColor=ffffff)](https://www.openssl.org/) 
[![OAuth](https://img.shields.io/badge/OAuth-0A2540?logo=oauth&logoColor=ffffff)](https://oauth.net/)

## BI / Data Science / ML (opcionales)
[![Pandas](https://img.shields.io/badge/Pandas-150458?logo=pandas&logoColor=ffffff)](https://pandas.pydata.org/) 
[![NumPy](https://img.shields.io/badge/NumPy-013243?logo=numpy&logoColor=ffffff)](https://numpy.org/) 
[![TensorFlow](https://img.shields.io/badge/TensorFlow-FF6F00?logo=tensorflow&logoColor=ffffff)](https://www.tensorflow.org/)

## Herramientas / IDEs
[![VS Code](https://img.shields.io/badge/VS_Code-007ACC?logo=visualstudiocode&logoColor=ffffff)](https://code.visualstudio.com/) 
[![IntelliJ IDEA](https://img.shields.io/badge/IntelliJ-000000?logo=intellijidea&logoColor=ffffff)](https://www.jetbrains.com/idea/) 
[![Postman](https://img.shields.io/badge/Postman-FF6C37?logo=postman&logoColor=ffffff)](https://www.postman.com/) 
[![Swagger](https://img.shields.io/badge/Swagger-85EA2D?logo=swagger&logoColor=000000)](https://swagger.io/)

## Formato y documentación
[![Markdown](https://img.shields.io/badge/Markdown-000000?logo=markdown&logoColor=ffffff)](https://www.markdownguide.org/) 
[![OpenAPI](https://img.shields.io/badge/OpenAPI-6DB33F?logo=openapi&logoColor=ffffff)](https://www.openapis.org/)

---

### Cómo personalizar
- Para cambiar el texto del badge (por ejemplo, poner versión), edita la URL:
  `https://img.shields.io/badge/Nombre-VALOR?logo=logoName&logoColor=ffffff`
